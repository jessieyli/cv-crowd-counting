...
def load_pretrained_weights(model, weights_path):
    '''
    helper function used to load darknet YOLO v3 weights.

    :param model: the YOLO v3 model
    :param weights_path: Path to the file with YOLO V3 weights
    '''
...
def weights_download(out='models/yolov3.weights'):
    if not os.path.exists('models/yolov3.weights'):
      print("downloading pre-trained weights")
      _ = wget.download(
          'https://pjreddie.com/media/files/yolov3.weights', out='models/yolov3.weights')
